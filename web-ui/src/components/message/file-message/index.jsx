...
const FileMessage = React.memo(({ content, filename, fileSize, direction }) => {
    ...
    return (
        <div style={{ cursor: 'pointer' }} onClick={() => handlerFileMessageClick(content, filename)}>
            <Flex align='center' className={`other-file-message ${direction === 'RIGHT' ? 'other-file-message-right' : 'other-file-message-left'}`} gap="middle" style={{ width: '200px', height: '80px' }}>
